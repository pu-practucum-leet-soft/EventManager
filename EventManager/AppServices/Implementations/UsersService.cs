...
namespace EventManager.AppServices.Implementations
{
    public class UsersService : IUsersService
    {
        ...
        public UsersService(EventManagerDbContext context, IConfiguration configuration, IJwtHelper jwtHelper)
        {
            _context = context;
        ...
        public async Task<LoginResponse> LoginAsync(LoginRequest request)
        {
            ...
            try
            {
                ...
                response.StatusCode = BusinessStatusCodeEnum.Success;
                response.Token = await _jwtHelper.GenerateJwtToken(user.Id.ToString(), user.Role);
